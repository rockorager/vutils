...
# Unicode-specific tests only make sense in UTF-8 locale
# In C locale, GNU and vutils both use ASCII-only whitespace but
# GNU's libc iswspace() has quirks with high bytes that we don't match
